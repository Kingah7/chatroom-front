  ...
  <div class="chat-window">
    <div class="top">
      ...
      <div class="info-detail">
        ...
        <div class="detail">{{ chatList[0].data }}</div>
      </div>
      <div class="other-fun">
      ...
      <div class="chat-content" ref="chatContent">
        <div class="chat-wrapper" v-for="item in chatList" :key="item.id">
          ...
          <div class="chat-me" v-else>
            <div class="chat-text" v-if="item.chatType == 'text'">
              {{ item.data }}
            </div>
            <div class="chat-img" v-if="item.chatType == 1">
              <img
...
export default {
  ...
  mounted() {
    ...
    reqHeadImg("kingah").then(resp =>{
      this.headImg = resp.data;
    })
    reqHeadImg(this.friendInfo.name).then(resp => {
      this.friendHeadImg = resp.data;
    })
  },
  methods: {
    //发送文字信息
