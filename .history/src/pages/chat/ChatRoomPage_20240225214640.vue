    ...
    <div class="botoom">
      <div class="chat-content" ref="chatContent">
        <div class="chat-wrapper" v-for="item in chatList" :key="item.id">
          <!-- 如果是朋友 -->
          <div class="chat-friend" v-if="item.fromUser == friendInfo.name">
            <div class="chat-text" v-if="item.dataType == 'text'">
              {{ item.data }}
            </div>
            <!-- 图片 -->
            <div class="chat-img" v-if="item.dataType == 'image'">
              <img
                :src="item.msg"
                alt="表情"
          ...
          <div class="chat-me" v-else-if="item.fromUser == userName">
            <div class="chat-text" v-if="item.dataType == 'text'">
              {{ item.data }}
            </div>
...
export default {
  ...
  methods: {
    ...
    sendEmoji(msg) {
      const chatMsg = {
        fromUser: this.userName,
        receiveUser: this.friendInfo.nam
        data: msg,
    ...
    sendImg(e) {
      ...
      reader.onloadend = function () {
        chatMsg.data = this.result; //赋值
        _this.srcImgList.push(chatMsg.data);
      };
